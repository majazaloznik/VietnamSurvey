...
9. `a2` is OK - but it is Year of birth, not age as the questionnaire states. Which begs the question as to which version of the questionnaire this is and whether it might be possible to get the VN one as well?
10. `a4` four missing values for school. Just curious as to why?
11. `a5` two responses *Other (specify)* according to the questionnaire, but where are the open ended questions?
11. `a6` eight responses *Other (specify)* according to the questionnaire, but where are the open ended questions?
