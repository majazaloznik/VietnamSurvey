...
`hh.id == 28 & hh.member.id == 99`---`"Spouse" <- "Respondent"`
...
`hh.id == 118 & hh.member.id == 371`---`"Spouse" <- "Respondent"`
...
`hh.id == 288 & hh.member.id == 1024`---`"Spouse" <- "Son"`
...
`hh.id == 290 & hh.member.id == 1035`---`"widow/widower" <- "married"`
...
`hh.id == 34 & hh.member.id == 116`---`"Spouse" <- "Son"`
