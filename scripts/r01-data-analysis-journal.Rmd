...
6. Hmm, in order for this to work, I had to rewrite the vioplot funciton, since it had a weird thing where you passed it a number of vectors and it then created a list. Which doesnt' really work if you don't know how many vectors you have. 
...
8. So I have manually changed the variabel descriptions for about 40 vasriables in the `02-data-clean.R` file.
